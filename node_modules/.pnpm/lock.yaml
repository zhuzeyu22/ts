...
dependencies:
  mobx: 6.9.0
  ts-loader: 9.4.2_b73sldshwrlnhikvubwhfqvrfa
  tsconfig-paths-webpack-plugin: 4.0.1
  typescript: 5.0.4
...
packages:
  ...
  /@types/bindings/1.5.1:
    resolution: {integrity: sha512-8HzueDeoxGXdsJ0Ep7TOXHGN+woRTWa1bAds30r5we7PCC3P5zrSTRknePLn/KYAubgQv5t/1zkonnStHLCWOg==}
    dependencies:
      '@types/node': 18.16.10
    dev: true
  ...
  /nrm/1.2.5:
    resolution: {integrity: sha512-QOfdBSDsrSso87Lluacdp7fXqU68c1EcjdKOKsr2SRPGXHWsxr88BNjxxJEwSKHP0cXutgUjJevxPhuYEwobMA==}
    hasBin: true
    dependencies:
      async: 1.5.2
      commander: 2.20.3
